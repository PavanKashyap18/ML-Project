Main.py is the Main python file use this file for running the project

Here we have Analysed the risk of the particular area as high or low by K-means Clustering, rule mining for drivers by using Apriori algorithm and entry new data as a future enhancement and plotting the graphs using matplotlib library, so that the drivers could be concious about his driving and helps in avoiding the accidents
...
Here 'Main.py' is the main file where all the operations are done 
