...
root.iconbitmap(r'accident.ico')
root.geometry('900x800')
root.configure(background="skyblue")

var = StringVar()
label = Label( root, textvariable = var,font=('arial',20,'bold'),bd=20,background="skyblue", foreground='navy')
var.set("Accident Prediction system")
label.grid(row=0,columnspan=10)


#my_image = ImageTk.PhotoImage(Image.open('loginpage1.jpg'))
#my_label=Label(image=my_image)
#my_label.grid()

#bg = PhotoImage(file='loginpage1.jpg')
#my_label=Label(root1, image=bg)
#my_label.place(x=0,y=0,relwidth=1,relheight=1)

#bg = PhotoImage(file='plainlogin.png')
#my_canvas=Canvas(root1, width=600, height=500)
...
def risk_file():
     ...
     root1.iconbitmap(r'login.ico')
     root1.geometry('600x500')
     root1.configure(background="skyblue")
     ...
     L=Label(root1, text = "Username",bd=8,background="skyblue",height=1,padx=16,pady=16,font=('arial',16,'bold'),width=10,).grid(row = 0,column=0)
     E=Entry(root1,borderwidth=2)
     E.grid(row = 0, column = 1)
     L1=Label(root1, text = "Password",bd=8,background="skyblue",height=1,padx=16,pady=16,font=('arial',16,'bold'),width=10,).grid(row = 1,column=0)
     E1=Entry(root1,show="*",borderwidth=2)
     E1.grid(row = 1, column = 1)
     B1=Button(root1,text="Login",width=7,height=1,command=login,bd=8,background="white")
...
def Rule_display():
    root1=Tk()
    root1.title("Rules")
    root1.iconbitmap(r'Rules.ico')
    root1.geometry('800x800')
    root1.configure(background="skyblue")
    

    
    label_6 = ttk.Label(root1, text = 'Support',font=("Helvetica", 18),background="skyblue")
    label_6.grid(row=1,column=0)
    
    Entry_6 = Entry(root1,borderwidth=2)
    Entry_6.grid(row=1,column=1)
    
    
    
    label_7 = ttk.Label(root1, text = 'Confidence',font=("Helvetica", 18),background="skyblue")
    label_7.grid(row=3,column=0)
    
    Entry_7 = Entry(root1,borderwidth=2)
    Entry_7.grid(row=3,column=1,padx=2)
    ...
    Text_rule = Text(root1,borderwidth=4)
    Text_rule.grid(row=4,column=1,pady=6)
    
    B3 = Button(root1, text = "Mine",height=1,padx=18,pady=14,bd=7,font=('arial',16,'bold'),width=8,bg="white",fg='OrangeRed3',command=ruleplot)
...
def new_data():
    ...
    root10.iconbitmap(r'keyboard.ico')
    root10.geometry('400x400')
    root10.configure(background="skyblue")
    ...
    """
    label_1 = ttk.Label(root10, text ='Date',font=("Helvetica", 16),background="skyblue")
    label_1.grid(row=0,column=0)
    
    Entry_1 = Entry(root10,borderwidth=3)
    Entry_1.grid(row=0,column=1)
    
    label_2 = ttk.Label(root10, text = 'Time',font=("Helvetica", 16),background="skyblue")
    label_2.grid(row=1,column=0)
    
    Entry_2 = Entry(root10,borderwidth=2)
    Entry_2.grid(row=1,column=1)
    
    label_3 = ttk.Label(root10, text = 'Location',font=("Helvetica", 16,),background="skyblue")
    label_3.grid(row=2,column=0)
    
    Entry_3 = Entry(root10,borderwidth=2)
    Entry_3.grid(row=2,column=1)
    
    label_4 = ttk.Label(root10, text = 'Type of vehicle' ,font=("Helvetica", 16),background="skyblue")
    label_4.grid(row=3,column=0)
    
    Entry_4 = Entry(root10,borderwidth=2)
    Entry_4.grid(row=3,column=1)
    
    label_5 = ttk.Label(root10, text = 'Type of accident',font=("Helvetica", 16),background="skyblue")
    label_5.grid(row=4,column=0)
    
    Entry_5 = Entry(root10,borderwidth=2)
    Entry_5.grid(row=4,column=1)
    
    label_6 = ttk.Label(root10, text = 'No of Casualities',font=("Helvetica", 16),background="skyblue")
    label_6.grid(row=5,column=0)
    
    Entry_6 = Entry(root10,borderwidth=2)
    Entry_6.grid(row=5,column=1)
    
    label_7 = ttk.Label(root10, text = 'Vehicle Number',font=("Helvetica", 16),background="skyblue")
    label_7.grid(row=6,column=0)
    
    Entry_7 = Entry(root10,borderwidth=2)
...
def risk_predict():
    ...
    root11.geometry('600x400')
    root11.iconbitmap(r'risk.ico')
    root11.configure(background="skyblue")
    
    var = StringVar()
    label = Label( root11, textvariable = var,font=('arial',20,'bold'),bd=20,background="skyblue")
    var.set("RISK PREDICTION")
    label.grid(row=0,columnspan=6)
    
    label_1 = ttk.Label(root11, text ='Area',font=("Helvetica", 16),background="skyblue")
    ...
    label_7.grid(row=8,column=1,padx=5,pady=3)
        
   
            
    Entry_12 = Entry(root11,borderwidth=2)
    Entry_12.grid(row=8,column=2,padx=3)

    Entry_11 = Entry(root11,borderwidth=2)
    Entry_11.grid(row=0,column=2)    

    label_8 = Button(root11, text = 'train',font=("Helvetica", 16),background="white",command = pass1)
    label_8.grid(row=0,column=1,pady=1) 
    
    
def plot_graph():
    root10 = Tk()
    root10.title('GRAPHS')
    root10.geometry('500x400')
    root10.iconbitmap(r'bargraph.ico')
    ...
    def graph1():
        ...
        image = image.resize((450, 220), Image.ANTIALIAS)
        img = ImageTk.PhotoImage(image)  
        panel1 = Label(root, image=img)
        panel1.image = img
        panel1.grid(row=3,column=1,padx=3,pady=5)
    ...
    def graph2():
        ...
        panel2.image = img
        panel2.grid(row=3,column=3,padx=3,pady=5)
    
    def graph3():
        image = Image.open("graph3.png")
        image = image.resize((600, 280), Image.ANTIALIAS)
        img = ImageTk.PhotoImage(image)  
        panel3 = Label(root, image=img)
        panel3.image = img
        panel3.grid(row=5,column=1,padx=4,pady=4)
    ...
    B_rule = Button(root10, text = "graph1",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="lightblue",command=graph1,fg='purple1')
    B_rule.grid(row=2,column=0,padx=6,pady=4) 
    
    B = Button(root10, text = "graph2",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="lightblue",command=graph2,fg='brown')
    B.grid(row=3,column=0,padx=5)
    
    B1 = Button(root10, text = "graph3",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="lightblue",command=graph3,fg='DarkOrange2')
    B1.grid(row=2,column=4)
    
    B3 = Button(root10, text = "graph4",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="lightblue",command=graph4,fg='red3')
...
B_rule = Button(root, text = "Rules",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="gold2",command=rule_file)
B_rule.grid(row=1,column=1,padx=2,pady=4) 

B = Button(root, text = "Risk Prediction",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="OrangeRed2",command=risk_file)
B.grid(row=2,column=1)

label_00 = ttk.Label(root,background="white")
label_00.grid(row=1,column=3)

B1 = Button(root, text = "Plot Graph",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="darkorange",command=plot_graph)
B1.grid(row=1,column=4)

B3 = Button(root, text = "Entry New Data",height=1,padx=16,pady=16,bd=8,font=('arial',16,'bold'),width=10,bg="lightgreen",command=new_data)
